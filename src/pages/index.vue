    ...
    <div id="loginBox">
      ...
      >
        ...
        >
          <el-row>
            <el-col :span='2'>
              <span><i class="fa fa-user-circle" aria-hidden="false"></i></span>
            </el-col>
            <el-col :span='22'>
              <el-input
                class="inps"
  ...
  methods: {
    ...
    createStar (params) {
      ...
      if (params) {
        ...
        for (var j = 0; j < 30; j++) {
          this.stars[j].shadowColor = this.shadowColorList[Math.floor(Math.random() * this.shadowColorList.length)]
        }
